<main class="content">
    ...
    <div class="summary-boxes">
        ...
        <div class="summary-box bg-danger">
            ...
            <h3 class="value"><?= count($absentsUsers) ?></h3>
        </div>
    ...
    <?php if(count($absentsUsers) > 0) : ?>
        <div class="card mt-4">
            <div class="card-header">
                <h4 class="card-title">Faltosos do Dia</h4>
                <p class="card-category mb-0">Relação dos funcionátios que ainda não bateram o ponto</p>
            </div>
            <div class="card-body">
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        <?php foreach($absentsUsers as $name) : ?>
                            <tr>
                                <td><?= $name ?></td>
                            </tr>
                        <?php endforeach ?>
